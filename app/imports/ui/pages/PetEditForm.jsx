...
const bridge = new SimpleSchema2Bridge(Pets.schema);

/** Renders the Page for editing a single document. */
class PetEditForm extends React.Component {

  // On successful submit, insert the data.
  submit(data) {
    const { firstName, lastName, email, phoneNumber, status, microchipCode, _id } = data;
    Pets.collection.update(_id, { $set: { firstName, lastName, email, phoneNumber, status, microchipCode } }, (error) => (error ?
